...
// step 3 - must start a loop, trying every possible password, until you find the good one.
...
// already implemented. don't change it. but you can read its code to get some hints for setupPinForBruteforce
...
// if code is 4242, must simulate 4 then 2 then 4 then 2 then *
